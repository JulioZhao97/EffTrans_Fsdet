...
VOC_SPLIT_TB = dict(
    ALL_CLASSES_SPLIT1=('014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS', '006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1','019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs'),
    ALL_CLASSES_SPLIT2=('019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs','014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS', '006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1'),
    ALL_CLASSES_SPLIT3=('006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1','019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs','014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS'),
    NOVEL_CLASSES_SPLIT1=('019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs'),
    NOVEL_CLASSES_SPLIT2=('006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1'),
    NOVEL_CLASSES_SPLIT3=('014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS'),
    BASE_CLASSES_SPLIT1=('014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS', '006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1'),
    BASE_CLASSES_SPLIT2=('019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs','014-VOA', '015-DWTV', '002-beijingweishi', '008-shenzhenweishi', '016-CBS'),
    BASE_CLASSES_SPLIT3=('006-henanweishi', '003-tianjinweishi', '005-shandongweishi', '019-TVBS', '001-CCTV1','019-fenghuangweishi', '004-CNN', '011-history_channel', '010-sichuanweishi', '020-tbs'))

@DATASETS.register_module()
class FewShotVOCDatasetTB(BaseFewShotDataset):
...
@DATASETS.register_module()
class FewShotVOCCopyDatasetTB(FewShotVOCDatasetTB):
...
@DATASETS.register_module()
class FewShotVOCDefaultDatasetTB(FewShotVOCDatasetTB):
    ...
    voc_benchmark = {
        f'SPLIT{split}_{shot}SHOT': [
            dict(
                type='ann_file',
                ann_file=f'data/few_shot_ann/tb/benchmark_{shot}shot/'
                f'box_{shot}shot_{class_name}_train.txt',
                ann_classes=[class_name])
            for class_name in VOC_SPLIT_TB[f'ALL_CLASSES_SPLIT{split}']
        ]
    ...
    voc_benchmark = {
        f'SPLIT{split}_{shot}SHOT_TASK{task}': [
            dict(
                type='ann_file',
                ann_file=f'data/few_shot_ann/tb/benchmark_{shot}shot/task{task}/'
                f'box_{shot}shot_{class_name}_train.txt',
                ann_classes=[class_name])
            for class_name in VOC_SPLIT_TB[f'ALL_CLASSES_SPLIT{split}']
        ]
        for shot in [1, 2, 3, 5, 10] for split in [1, 2, 3] for task in [0, 1, 2, 3, 4]
    }
    ...
    """
    print(type(DEFAULT_ANN_CONFIG))
    for k, _ in DEFAULT_ANN_CONFIG['TFA'].items():
        print(k)
    #sys.exit()
    """
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        for ann_cfg_ in ann_cfg:
            ...
            task = ann_cfg_['task']
            print(method, setting, task)
            #print(method, setting)
            #print(self.DEFAULT_ANN_CONFIG)
            #default_ann_cfg = self.DEFAULT_ANN_CONFIG[method][setting]
            default_ann_cfg = self.DEFAULT_ANN_CONFIG[method]['{}_{}'.format(setting, task)]
        ...
        #print(ann_cfg)
        #print(new_ann_cfg)
        return super(FewShotVOCDatasetTB, self).ann_cfg_parser(new_ann_cfg)
