...
class QueryAwareDataset:
    ...
    def __init__(self,
        ...
        self.support_idxes = [(472, 0), (192, 0)]
    ...
    def __getitem__(self, idx: int) -> Dict:
        ...
        #if self.support_idxes is None:
            #print('fuck*10')
            #self.support_idxes = support_idxes
        ...
        """
        #print(query_class, support_class, self.support_idxes)
        support_data = [
            self.support_dataset.prepare_train_img(idx, 'support', [gt_idx])
            for (idx, gt_idx) in self.support_idxes
        ]
        """
...
@DATASETS.register_module()
class NWayKShotSingleDataset(object):
    """A dataset wrapper of NWayKShotDataset.
