...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='FSDetView', setting='SPLIT1_10SHOT', task='TASK0')],
...
log_level = 'INFO'
load_from = 'work_dirs/tb/fsdetview/split1/fsdetview_r101_c4_8xb4_tb-split1_base-training/iter_10000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/fsdetview/split1/fsdetview_r101_c4_8xb4_tb-split1_10shot-fine-tuning'
gpu_ids = range(0, 4)