...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='FSDetView', setting='SPLIT2_1SHOT', task='TASK0')],
...
seed = 42
work_dir = './work_dirs/tb/fsdetview/split2/fsdetview_r101_c4_8xb4_tb-split2_1shot-fine-tuning'
gpu_ids = range(0, 4)