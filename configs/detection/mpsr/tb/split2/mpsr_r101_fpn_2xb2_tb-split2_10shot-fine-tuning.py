...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MPSR', setting='SPLIT2_10SHOT', task='TASK0')],
...
log_level = 'INFO'
load_from = './work_dirs/tb/mpsr/split2/mpsr_r101_fpn_2xb2_voc-split2_base-training/iter_10000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/mpsr/split2/mpsr_r101_fpn_2xb2_tb-split2_10shot-fine-tuning'
gpu_ids = range(0, 4)