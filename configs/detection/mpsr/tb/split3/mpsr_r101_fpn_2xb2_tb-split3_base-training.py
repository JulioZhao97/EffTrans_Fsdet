...
data = dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[
                dict(
                    type='ann_file',
                    ann_file=
                    'data/VOCdevkit_tb/VOC2007/ImageSets/Main/few-shot/trainval.txt')
            ],
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/VOCdevkit_tb/VOC2007/ImageSets/Main/test.txt')
        ],
        img_prefix='data/VOCdevkit_tb/',
        pipeline=[
            dict(type='LoadImageFromFile'),
        ...
        classes='BASE_CLASSES_SPLIT3'))
evaluation = dict(
    interval=2000, metric='mAP', class_splits=['BASE_CLASSES_SPLIT3'])
optimizer = dict(
    type='SGD',
    lr=0.005,
    momentum=0.9,
...
seed = 42
work_dir = './work_dirs/tb/mpsr/split3/mpsr_r101_fpn_2xb2_voc-split3_base-training'
gpu_ids = range(0, 4)