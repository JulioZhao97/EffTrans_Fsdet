...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='TFA', setting='SPLIT3_10SHOT', task='TASK0')],
...
log_level = 'INFO'
load_from = './work_dirs/tb/split3/tfa_r101_fpn_tb-split3_base-training/base_model_random_init_bbox_head.pth'
#resume_from = './work_dirs/tb/tfa_r101_fpn_tb-split1_1shot-fine-tuning/iter_40000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/split3/10shot/task0/tfa_r101_fpn_tb-split3_10shot-fine-tuning-my-ema'
gpu_ids = range(0, 4)