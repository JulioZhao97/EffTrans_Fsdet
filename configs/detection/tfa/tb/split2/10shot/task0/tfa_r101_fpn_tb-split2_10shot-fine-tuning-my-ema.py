...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='TFA', setting='SPLIT2_10SHOT', task='TASK0')],
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='CosineSimBBoxHeadMyTuneTestEMATB',
            in_channels=256,
            ...
            num_shared_fcs=2,
            scale=20,k=1,alpha=0.0001,ema_n=10**6)),
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
...
log_level = 'INFO'
load_from = './work_dirs/tb/split2/tfa_r101_fpn_tb-split2_base-training/base_model_random_init_bbox_head.pth'
#resume_from = './work_dirs/tb/tfa_r101_fpn_tb-split1_1shot-fine-tuning/iter_40000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/split2/10shot/task0/tfa_r101_fpn_tb-split2_10shot-fine-tuning-my-ema'
gpu_ids = range(0, 4)