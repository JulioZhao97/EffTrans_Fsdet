...
log_level = 'INFO'
load_from = './work_dirs/tb/split1/2shot/task0/tfa_r101_fpn_tb-split1_2shot-fine-tuning-my-ema/best.pth'
#resume_from = './work_dirs/tb/tfa_r101_fpn_tb-split1_1shot-fine-tuning/iter_40000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/split1/2shot/task0/tfa_r101_fpn_tb-split1_2shot-fine-tuning-my-ema-distill'
gpu_ids = range(0, 4)