...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/VOCdevkit_tb/VOC2007/ImageSets/Main/few-shot/trainval.txt'
            )
        ],
...
log_level = 'INFO'
load_from = './work_dirs/tb/split1/tfa_r101_fpn_tb-split1_base-training/iter_10000.pth'
#resume_from = './work_dirs/tb/tfa_r101_fpn_tb-split1_base-training/iter_10000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = False
seed = 42
work_dir = './work_dirs/tb/split1/tfa_r101_fpn_tb-split1_base-training-my'
gpu_ids = range(0, 4)