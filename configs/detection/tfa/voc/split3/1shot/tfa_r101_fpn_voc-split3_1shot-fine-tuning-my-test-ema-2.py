...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            num_shared_fcs=2,
            scale=20,k=5,alpha=0.001,beta_novel=(10**5-1)/10**5,beta_base=(10**5-1)/10**5)),
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
...
seed = 42
work_dir = './work_dirs/voc/tfa/1shot/tfa_r101_fpn_voc-split3_1shot-fine-tuning-my-test-ema-2'
gpu_ids = range(0, 1)