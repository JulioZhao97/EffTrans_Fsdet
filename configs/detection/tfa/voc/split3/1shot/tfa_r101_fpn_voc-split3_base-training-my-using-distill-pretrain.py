...
log_level = 'INFO'
load_from = 'work_dirs/voc/tfa/split3/1shot/tfa_r101_fpn_voc-split3-1shot-base-class-bbox-head-based-on-distill.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = False
seed = 42
work_dir = './work_dirs/voc/tfa/split3/1shot/tfa_r101_fpn_voc-split3_base-training-my-using-distill-pretrain'
gpu_ids = range(0, 1)