...
log_level = 'INFO'
load_from = './work_dirs/voc/tfa/split3/1shot/tfa_r101_fpn_voc-split3_1shot-fine-tuning-distill/iter_3000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/voc/tfa/split3/1shot/tfa_r101_fpn_voc-split3_1shot-fine-tuning-my-based-on-distill'
gpu_ids = range(0, 1)