...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='CosineSimBBoxHeadMyTuneTestEMA',
            in_channels=256,
            ...
            num_shared_fcs=2,
            scale=20,k=5,alpha=0.001,beta_novel=(10**4-1)/10**4,beta_base=(10**4-1)/10**4)),
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
...
log_level = 'INFO'
load_from = 'work_dirs/voc/tfa/split3/tfa_r101_fpn_voc-split3_base-training_20211031_114840_random-init-bbox-head-9bb8c09b.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/voc/tfa/1shot/tfa_r101_fpn_voc-split3_1shot-fine-tuning-my-test-ema-3'
gpu_ids = range(0, 1)