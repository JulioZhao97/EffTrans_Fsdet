...
log_level = 'INFO'
load_from = '/data/zhaozhiyuan/mmfewshot-main/work_dirs/voc/tfa/split2/tfa_r101_fpn_voc-split2_base-training_20211031_114820_random-init-bbox-head-3d4c632c.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/voc/tfa/split2/10shot/tfa_r101_fpn_voc-split2_10shot-fine-tuning'
gpu_ids = range(0, 1)