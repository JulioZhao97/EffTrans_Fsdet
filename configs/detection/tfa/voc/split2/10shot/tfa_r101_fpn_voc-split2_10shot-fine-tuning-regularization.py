...
log_level = 'INFO'
load_from = 'work_dirs/voc/tfa/split2/tfa_r101_fpn_voc-split2_base-training_20211031_114820_base-class-bbox-head-3d4c632c.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/voc/tfa/split2/10shot/tfa_r101_fpn_voc-split2_10shot-fine-tuning-regularization'
gpu_ids = range(0, 1)