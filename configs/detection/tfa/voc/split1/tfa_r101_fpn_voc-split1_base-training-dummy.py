...
lr_config = dict(
    ...
    warmup_ratio=0.001,
    step=[30000,40000])
runner = dict(type='IterBasedRunner', max_iters=50000000)
model = dict(
    type='FasterRCNN',
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100)))
checkpoint_config = dict(interval=50000000)
...
seed = 42
work_dir = './work_dirs/voc/tfa/split1/tfa_r101_fpn_voc-split1_base-training-dummy'
gpu_ids = range(0, 4)