...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[dict(method='TFA', setting='3SHOT')],
...
log_level = 'INFO'
#load_from = './work_dirs/coco/tfa/tfa_r101_fpn_coco_base-training_20211102_030413_random-init-bbox-head-ea1c2981.pth'
load_from = './work_dirs/coco/tfa/3shot/tfa_r101_fpn_coco_3shot-fine-tuning-my-k-1-alpha-00001/best.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/coco/tfa/3shot/tfa_r101_fpn_coco_3shot-fine-tuning-distill'
gpu_ids = range(0, 3)