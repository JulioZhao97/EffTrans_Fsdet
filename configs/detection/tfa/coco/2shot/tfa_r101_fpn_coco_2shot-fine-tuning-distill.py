...
data = dict(
    ...
    train=dict(
        ...
        ann_cfg=[dict(method='TFA', setting='2SHOT')],
...
load_from = './work_dirs/coco/tfa/2shot/tfa_r101_fpn_coco_2shot-fine-tuning-my-k-5-alpha-001/best.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/coco/tfa/2shot/tfa_r101_fpn_coco_2shot-fine-tuning-distill'
gpu_ids = range(0, 3)