...
log_level = 'INFO'
load_from = './work_dirs/coco/tfa/10shot/tfa_r101_fpn_coco_10shot-fine-tuning-my-k-5-ema-10e6/best.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/coco/tfa/10shot/tfa_r101_fpn_coco_10shot-fine-tuning-test-distill'
gpu_ids = range(0, 3)