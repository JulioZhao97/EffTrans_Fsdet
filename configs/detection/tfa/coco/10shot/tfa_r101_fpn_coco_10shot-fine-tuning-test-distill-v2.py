...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=100)),
    frozen_parameters=['backbone', 'neck', 'rpn_head', 'bridge'])
...
seed = 42
work_dir = './work_dirs/coco/tfa/10shot/tfa_r101_fpn_coco_10shot-fine-tuning-test-distill-v2'
gpu_ids = range(0, 3)