...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            type='CosineSimBBoxHeadMyTuneCOCOTestEMA',
            in_channels=256,
            ...
            num_shared_fcs=2,
            scale=20,k=5,alpha=0.0001,ema_n=15000)),
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
...
seed = 42
work_dir = './work_dirs/coco/tfa/1shot/tfa_r101_fpn_coco_1shot-fine-tuning-my-k-5-alpha-00001-ema-15000'
gpu_ids = range(0, 3)