...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        ann_cfg=[dict(method='FSCE', setting='SPLIT1_10SHOT', task='TASK0')],
...
log_level = 'INFO'
load_from = './work_dirs/tb/fsce/split1/fsce_r101_fpn_tb-split1_base-training/base_model_random_init_bbox_head.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/fsce/split1/fsce_r101_fpn_tb-split1_10shot-fine-tuning'
gpu_ids = range(0, 4)