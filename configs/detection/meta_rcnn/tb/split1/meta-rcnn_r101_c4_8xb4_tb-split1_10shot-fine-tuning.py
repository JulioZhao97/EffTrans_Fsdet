...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT1_10SHOT', task='TASK0')],
...
seed = 42
work_dir = './work_dirs/tb/meta_rcnn/split1/meta-rcnn_r101_c4_8xb4_tb-split1_10shot-fine-tuning'
gpu_ids = range(0, 4)