...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT3_10SHOT', task='TASK0')],
...
checkpoint_config = dict(interval=100000000)
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook'),dict(type='TensorboardLoggerHook')])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = './work_dirs/tb/meta_rcnn/split3/meta-rcnn_r101_c4_8xb4_voc-split3_base-training/iter_10000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/meta_rcnn/split3/meta-rcnn_r101_c4_8xb4_tb-split3_10shot-fine-tuning'
gpu_ids = range(0, 4)