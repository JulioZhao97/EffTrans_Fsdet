...
data_root = 'data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split4/'
data = dict(
    samples_per_gpu=4,
    workers_per_gpu=2,
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT4_1SHOT', task='TASK0')],
            img_prefix='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split4',
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split4/VOC2007/ImageSets/Main/test_across_style.txt')
        ],
        img_prefix='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split4',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
seed = 42
work_dir = './work_dirs/Flickr-FoodLogos-10/meta_rcnn/split4/1shot/meta-rcnn_r101_c4_8xb4_food-split4_1shot-fine-tuning'
gpu_ids = range(0, 4)