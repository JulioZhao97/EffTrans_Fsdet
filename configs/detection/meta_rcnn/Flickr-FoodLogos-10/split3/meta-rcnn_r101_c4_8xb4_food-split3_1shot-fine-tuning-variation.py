...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT3_1SHOT', task='TASK0')],
...
seed = 42
work_dir = './work_dirs/Flickr-FoodLogos-10/meta_rcnn/split3/1shot/meta-rcnn_r101_c4_8xb4_food-split3_1shot-fine-tuning'
gpu_ids = range(0, 4)