...
data = dict(
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split2/VOC2007/ImageSets/Main/test_across_style.txt')
        ],
        img_prefix='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split2',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
seed = 42
work_dir = './work_dirs/Flickr-FoodLogos-10/meta_rcnn/split2/1shot/meta-rcnn_r101_c4_8xb4_food-split2_1shot-fine-tuning'
gpu_ids = range(0, 4)