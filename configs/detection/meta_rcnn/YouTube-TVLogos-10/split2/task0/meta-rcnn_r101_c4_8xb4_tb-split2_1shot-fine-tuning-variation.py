...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT2_1SHOT', task='TASK0')],
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/VOCdevkit_var/VOC2007/ImageSets/Main/split2_2way_0607/val_across_style.txt')
        ],
        img_prefix='data/VOCdevkit_var/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
seed = 42
work_dir = './work_dirs/tb_variation/meta_rcnn/split2/1shot/meta-rcnn_r101_c4_8xb4_tb-split2_1shot-fine-tuning'
gpu_ids = range(0, 4)