...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='Attention_RPN', setting='SPLIT1_1SHOT', task='TASK0')],
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/VOCdevkit_var/VOC2007/ImageSets/Main/split1_2way_0607/val_within_style.txt')
        ],
        img_prefix='data/VOCdevkit_var/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/VOCdevkit_var/VOC2007/ImageSets/Main/split1_2way_0607/val_across_style.txt')
        ],
        img_prefix='data/VOCdevkit_var/',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
optimizer = dict(type='SGD', lr=0.0001, momentum=0.0, weight_decay=0.0001)
...
seed = 42
work_dir = './work_dirs/tb_variation/attention-rpn/split1/attention-rpn_r50_c4_tb-split1_1shot-fine-tuning'
gpu_ids = range(0, 4)