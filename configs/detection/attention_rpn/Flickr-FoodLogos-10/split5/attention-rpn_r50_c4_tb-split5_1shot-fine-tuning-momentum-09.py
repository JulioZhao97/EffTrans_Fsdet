...
data_root = 'data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split5/'
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=2,
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='Attention_RPN', setting='SPLIT5_1SHOT', task='TASK0')],
            img_prefix='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split5',
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split5/VOC2007/ImageSets/Main/test_across_style.txt')
        ],
        img_prefix='data/Flickr-FoodLogos-10/VOCdevkit_FoodLogo_split5',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
seed = 42
work_dir = './work_dirs/tb_variation/Flickr-FoodLogos-10/attention-rpn/split5/attention-rpn_r50_c4_tb-split5_1shot-fine-tuning'
gpu_ids = range(0, 4)