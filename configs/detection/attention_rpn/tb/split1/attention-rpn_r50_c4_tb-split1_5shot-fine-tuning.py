...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='Attention_RPN', setting='SPLIT1_5SHOT', task='TASK0')],
...
seed = 42
work_dir = './work_dirs/tb/attention_rpn/split1/attention-rpn_r50_c4_tb-split1_5shot-fine-tuning'
gpu_ids = range(0, 4)