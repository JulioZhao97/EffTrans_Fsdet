...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='Attention_RPN', setting='SPLIT2_10SHOT', task='TASK0')],
...
log_level = 'INFO'
load_from = './work_dirs/tb/attention_rpn/split2/attention-rpn_r50_c4_tb-split2_base-training/iter_12000.pth'
resume_from = None
workflow = [('train', 1)]
use_infinite_sampler = True
seed = 42
work_dir = './work_dirs/tb/attention_rpn/split2/attention-rpn_r50_c4_tb-split2_10shot-fine-tuning'
gpu_ids = range(0, 4)