...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='Attention_RPN', setting='SPLIT2_1SHOT', task='TASK0')],
...
seed = 42
work_dir = './work_dirs/tb/attention-rpn/split2/attention-rpn_r50_c4_tb-split2_1shot-fine-tuning'
gpu_ids = range(0, 4)